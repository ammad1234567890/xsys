        ...
        <div class="col-md-12">
            <div class="panel panel-info">
                <div class="panel-heading">
                    <h2 class="panel-title">Sale Orders<small class="pull-right"> Legends : <i class="fa fa-edit"> Edit</i> - <i class="fa fa-check"> Approve</i> - <i class="fa fa-eye"> View Detail</i> - <i class="fa fa-file"> Generate Invoice</i></small>
                    </h2>
