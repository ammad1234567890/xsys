                    ...
                    <div class="panel-body">
                        <form @submit="createIssue">
                          <div class="row">
                              ...
                              <div class="col-md-5"><button class="btn btn-primary" v-on:click="get_invoice_details($event)" :disabled="get_invoice_detail_btn_disabled">Get Invoice Details</button></div>
                              <!--
                                    ...
                                    <div class="row" style="margin-top:10px;">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <table class="table table-striped table-bordered table-hover">
                                                ...
                                                <div class="col-md-4">
                                    <input type="submit" class="btn btn-default" :disabled="submit_disabled" value="Submit">
...
import vSelect from "vue-select"
    export default {
      ...
      data(){
        return{
            get_invoice_detail_btn_disabled:false,
        ...
        watch: {
            warehouseissue: function () {
                if (this.warehouseIssue != '') {
                    this.get_invoice_detail_btn_disabled=false;
        ...
        methods:{
          ...
          createIssue(e){
            ...
            var total_qty=0;
            for(var i=0; i<this.products.length; i++){
                total_qty+= this.products[i].product_qty;

            }
            //alert(total_qty);
            if(this.newIssueItems.imei.length == total_qty){
                ...
                alert("Please Scan all the items, "+"Remaining "+(total_qty-this.newIssueItems.imei.length));
            }
            ...
            get_invoice_details:function(e){
                ...
                if(this.newIssueItems.invoice_id!=''){
                    this.get_invoice_detail_btn_disabled=true;
