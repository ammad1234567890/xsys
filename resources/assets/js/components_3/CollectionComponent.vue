...
<template>
        <div class="row">
                ...
                <div class="modal-dialog modal-md" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <h5><b>Deposit Slip: {{this.new_payment.deposit_slip_no}}</b></h5>
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-github" data-dismiss="modal" @click="submit_payment()">Submit Payment</button>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <!-- Alert Modal Start-->
            <div class="modal fade bs-add-Model-modal-md" tabindex="5" role="dialog"  id="payment_advance_modal" aria-labelledby="bs-add-Model-modal-md">
                <div class="modal-dialog modal-md" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <table class="table table-striped table-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                                        ...
                                        <tbody>
                                        <tr v-for="(advance_am, index) in new_advance_payment" v-if="advance_am.amount!=0">
                                            <td v-if="new_payment.payment_id==3">
                                                {{advance_am.cheque_no}}
                                            </td>
                                            <td>
                                                {{advance_am.amount | currency('Rs')}}
                                            </td>
                                        </tr>
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-github" data-dismiss="modal" @click="submit_advance_payment()">Submit Advance Payment</button>
                        </div>
                    </div>
                </div>
            </div>
                                ...
                                <div class="panel-body">
                                    <div class="col-md-12">
                                        <form @submit.prevent="get_outstanding_invoices">
                                            <div class="row">
                                                <div class="col-md-2"><label>Collection Type<span style="color:red;">*</span></label></div>
                                                <div class="col-md-3">
                                                    <select class="textbox_dropdown" v-model="selected_collection_type" required>
                                                        <option value="">Select Collection Type</option>
                                                        <option v-for="(c_type, index) in collection_types" v-bind:value="c_type.id">{{c_type.name}}</option>
                                                    </select>
                                                </div>
                                                <div class="col-md-1"></div>
                                            </div>
                                            <div class="row" v-if="selected_collection_type==1">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-1"></div>
                                                <div class="col-md-2" v-if="selected_collection_type==1"><label>Payment Type<span style="color:red;">*</span></label></div>
                                                <div class="col-md-3" v-if="selected_collection_type==1">
                                            ...
                                            <div class="row">
                                                <div class="col-md-11">
                                                    ...
                                                    <button type="submit" class="btn btn-success pull-right">Get Outstanding Invoices</button>
                    ...
                    <div class="col-md-12">
                        <div class="panel panel-info" >
                            ...
                            <div class="panel-body">
                                ...
                                <h5><b>Deposit Slip# {{new_payment.deposit_slip_no}}</b> <span style="float:right; font-weight: bold;">Total Amount: {{new_payment.amount_in_rs | currency('Rs')}}</span></h5>
