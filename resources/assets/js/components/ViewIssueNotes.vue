                                            ...
                                            <div class="table-responsive">
                                                <table id="approved-win" class="table table-striped table-bordered table-hover">
                                                    ...
                                                    <tr v-for="(issue_note, index) in approved_issue_notes">
                                                        ...
                                                        <td>{{issue_note.created_at | moment}}</td>
                                                        <td>
                                                            <button v-on:click="show_product_approve(index)">Products</button>
                                                            <a :href="'transferinvoice_print/'+issue_note.id" target="_blank" class="btn btn-primary" title="Generate Invoice"><i class="fa fa-file"></i> </a>
                                                            <a :href="'transferinvoiceimei_print/'+issue_note.id" target="_blank" class="btn btn-primary" title="Generate IMEI Invoice"><i class="fa fa-file"></i> </a>
                                                        </td>
                                                    </tr>
                                                    </tbody>
                                                </table>
