                          ...
                          <div class="row">
                            ...
                            <div class="row">
                                <div class="col-md-6 pull-right">
                                    ...
                                    <button  class="btn btn-primary pull-right"   v-on:click="saveEditing" v-if="editing==1">Save Editing</button>
                                    <button  class="btn btn-danger pull-right" style="margin-right: 43px;"  v-on:click="cancelEding" v-if="editing==1">Cancel Editing</button>
                                </div>
                            </div>
