                            ...
                            <div class="portlet-content ">
                                <div class="" style=" width:1000px;  overflow-x:scroll;">
                                    ...
                                    <table id="sale_sales" style="width: 3000px;"
                                        ...
                                        <tbody>
                                        <tr v-for="(value ,index ) in data_sales.data">
                                            <td>
                    ...
                    if (month != "") {
                        if (sales_report_type == "sales_wise") {
                            ...
                            if (response.data.status == true) {
                                ...
                                this.sales_days=response.data.day_total;
                        ...
                        if (sales_report_type == "quantity_wise") {
                            axios.post('report/get_sales_qty', data).then((response) => {
                                console.log(response.data);
                            if (response.data.status == true) {
                                this.data_sales_qty = response.data.data.data;
                                this.sales_qty_days=response.data.day_total;
                                this.total_sales_qty = response.data.total-response.data.sale_return;
                                $("#sale_qty").show();
                            } else {
                                //  alert("No Data Found");
                            }
