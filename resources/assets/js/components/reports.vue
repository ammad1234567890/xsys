                ...
                <div class="panel panel-info">
                    ...
                    <div class="panel-body">
                        <div class="row">
                            ...
                            <div class="col-md-4 m-p-0 display_none" id="warehouse_div">
                                <div class="col-md-4">
                                    <label>Warehouse</label>
                                </div>
                                <div class="col-md-8  " >
                                    <select id="warehouse_id"  class="textbox_dropdown form-control ">
                                        <option value="">All</option>
                                        <option v-for="(warehouse, index) in warehouse_details" v-bind:value="warehouse.id">
                                            {{warehouse.name}}
                                        </option>
                                    </select>
                                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 display_none  m-p-0" id="date_month_div">
                                <div class="col-md-4">
                                    <label>Type</label>
                                </div>
                                <div class="col-md-8">
                                    <select @change="type_date_filter" id="type_date" class="textbox_dropdown form-control">
                                        <option
                                                v-for="(filter, index) in type_date"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 display_none  m-p-0" id="div_activation_wise">
                                ...
                                <div class="col-md-8">
                                    <select id="activation_wise" @change="activation_type"
                                        ...
                                        <option value="">-Select-</option>
                                        <option v-for="(value) in filter_type"
                            ...
                            <div class="col-md-4  m-p-0 display_none" id="sales_return_report_type_wise">
                                <div class="col-md-4">
                                    <label>Type </label>
                                </div>
                                <div class="col-md-8">
                                    <select id="sales_return_type" class="textbox_dropdown form-control ">
                                        <option value="outlet_wise">Outlet Wise</option>
                                        <option value="imeis_wise">IMEIS Wise</option>
                                    </select>
                                </div>
                            </div>
                        </div>
    ...
    export default {
        ...
        filters: {
            ...
            report: function () {
                ...
                $('#date_month_div').hide();
                $("#warehouse_div").hide();
                $('#sales_return_report_type_wise').hide();
                ...
                if (report_type == "sale_return") {
                    ...
                    $('#div_tdate').show();
                    $('#div_filter').show();
                    $('#sales_return_report_type_wise').show();
                }
            },
            ...
            type_date_filter:function(){
                $('#div_fdate').hide();
                $('#div_tdate').hide();
                $('#month_div').hide();
            var type=$('#type_date').val();
            if(type=="date"){
                 $('#div_fdate').show();
                 $('#div_tdate').show();
            }
            ...
            all_warehouse:function(){
                axios.get('allWarehouses_details').then((response) => {
                    this.warehouse_details = response.data;
            });
            },
            state: function () {
            ...
            search: function () {
                ...
                if (report_type == "outstanding") {
                  ...
                  //      'tdate': tdate,
                    ...
                    if ($('#invoice_wise').val() != "invoice_wise") {
                        axios.post('report/get_outstanding_ledger', data).then((response) => {
                            if (response.data.status == true) {
               ...
               /*     if ($('#invoice_wise').val() != "invoice_wise") {
                ...
                if (report_type == "sale_return") { 
                    ...
                    if(fdate!="" && tdate!=""){
                    if($('#sales_return_type').val()=="outlet_wise"){
                    axios.post('report/get_sale_return', data).then((response) => { 
                        if (response.data.status == true) {
                            this.table_data['data']=response.data;
                            this.table_data['fdate']=fdate;
                            this.table_data['tdate']=tdate;
                            this.table_data['warehouse_id']=$('#warehouse_id').val();
                            this.report_table_type='sale_return';
                            this.is_component_loaded=true;
                            $("#sale_return_table").show();
                              this.report_name = 'sale_return_table';
                              this.file_name = 'Activate_Report_' + moment().format('DD-MM-YYYY');
                              $('.export_to_excell').show();
                            this.loading_show();
                        } else {
                    ...
                    else if($('#sales_return_type').val()=="imeis_wise"){
                        axios.post('sale_return_imeis_details', data).then((response) => {
                            if (response.data.status == true)
                        {
                            this.table_data['data'] = response.data.data;
                            this.table_data['total'] = response.data.total;
                            this.report_table_type = 'sale_return_imeis';
                            this.is_component_loaded = true;
                            this.report_name = 'sale_return_imeis_table';
                            this.file_name = 'Activate_Report_' + moment().format('DD-MM-YYYY');
                            $('.export_to_excell').show();
                            this.loading_show();
                        }
