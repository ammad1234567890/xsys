...
class RetailerOutlet extends Model {
    ...
    protected $fillable = ['retailer_id', 'city_id', 'region_id', 'name', 'latitude', 'longitude','sales_officer_id', 'address', 'phone_no', 'business_person_name', 'mobile_no', 'business_person_cnic', 'security_deposit_amount', 'security_deposit_image', 'credit_limit', 'credit_duration', 'credit_remaining', 'aging_amount', 'is_deleted', 'created_by', 'updated_by'];
