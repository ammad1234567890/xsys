...
class RetailerInvoice extends Model {
    ...
    protected $table = "tbl_invoice";
      protected $fillable = ['id','invoice_no' ,'order_id', 'discount_type_id', 'invoice_type_id', 'payment_type_id', 'total_amount','final_amount', 'description', 'created_by', 'updated_by'];
