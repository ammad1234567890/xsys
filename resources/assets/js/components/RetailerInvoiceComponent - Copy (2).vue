<template>
    <div>
        <div class="row">
		<center>
		<div class="card headcolor"><div class="card-header"><h2 class="card-title pad-bot"><strong>INVOICE</strong></h2></div></div>
		</center>
		</div>
        <form @submit.prevent="add_invoice">
            <div class="panel">
                <div class="panel-heading">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="col-md-12"><label><span class="h1">Xsys</span></label></div>
                            <br><br><br>
                            <div class="col-md-12"><label><b>Order NO</b> :</label> <input type="text" :value="order_no" class="bordernone"/></div>
							...
							<div class="panel-heading">
							<label><span class="h5">Company Details</span></label></div></div>
							</div>
							<div class="col-md-6">
							<div class="panel panel-default">
							<div class="panel-heading">
							<label><span class="h5">Bill To</span></label></div></div>
							</div>
							</div>
							<div class="col-md-12">
                            <div class="col-md-6"><label><b>Order NO</b> :</label>
                               <input type="text" :value="order_no" class="bordernone"/>  
                            </div>
<div class="col-md-6"><label><b>Outlet Name</b> : {{ outlet_name}}</label></div>
<div class="col-md-6"><label><b>Date</b> : {{ current_date}}</label>
                            </div>
  ...
  <div class="col-md-6 "></div>                                                     
                            <div class="col-md-6 "><label><b>Previous Balance</b> : Rs.{{previous_balance>0?previous_balance:0 | currency('')}}</label></div>
							  <div class="col-md-6 "></div>
